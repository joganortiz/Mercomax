            ...
            <div class="col-lg-12">
                <div class="product-top-dt">
                    <div class="product-left-title ">
                        <h1><img style=" height:30px; " src="{{asset('../resources/images/category/fruta-verdura.svg')}} " alt=""> Frutas y Verduras</h1> 
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-3 p-2 col-md-4 col-sm-4 col-6 ">
                            <div class="product-item mb-30" >
                                ...
                                <form action="{{ route('cart.add') }}" method="post">
                                    @method('PUT')
                                    @csrf
                                    <input type="hidden" name="producto_id" value="{{$key->id}} ">
                                    <input type="submit" id="botones" class="minus minus-btn" value="AGREGAR">
                                </form>
                            </div>  
                        </div>     
                    @endforeach
